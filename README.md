...
A sleek, lightweight, and modern web application designed for seamless real-time video broadcasting and viewing. Built to make live streaming simple, accessible, and instant for everyone directly from their browser.

---

## About the Project

**Promote 2026** is an interactive live streaming solution created to connect broadcasters and viewers with zero friction. Whether broadcasting a live event, delivering a quick presentation, or sharing moments with an audience, this platform enables direct, high-quality streaming without requiring any downloads, third-party software installations, or complicated setups.
...
- **One-Click Broadcasting**  
  Launch your own live video stream instantly using your webcam or camera directly from the web browser.

- **Effortless Sharing**  
  Generate unique stream IDs and shareable links to invite viewers to your live stream in seconds.

- **Real-Time Viewing Experience**  
  Viewers can effortlessly join live rooms by pasting a link or entering a stream ID with smooth, synchronized video playback.

- **In-Browser Recording**  
  Record live broadcasts on the fly with built-in recording controls, allowing both creators and viewers to save and download video sessions locally.

- **Live Viewer Counter & Status**  
  Keep track of your audience in real time with an active viewer indicator and stream status badges.

- **Modern & Responsive Design**  
  Designed with an elegant dark theme, ambient visual animations, and a mobile-friendly interface suited for desktops, tablets, and smartphones.

- **Event Countdown**  
  Includes an integrated countdown timer highlighting key milestones and scheduled event dates.

---

## How It Works

1. **Start a Stream**: Click **"Diffuser" (Broadcast)** to create a new live room and activate your camera feed.
2. **Share Your Link**: Copy the generated room link or ID and send it to your audience.
3. **Join & Watch**: Viewers paste the link or ID into **"Rejoindre" (Join)** to tune in live instantly.
